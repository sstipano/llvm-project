...
; GFX6-NEXT:    s_cselect_b64 s[8:9], s[10:11], s[14:15]
; GFX6-NEXT:    s_cmp_lg_u32 s16, 0
; GFX6-NEXT:    s_cselect_b64 s[8:9], s[0:1], s[8:9]
; GFX6-NEXT:    s_sub_i32 s13, s12, 64
; GFX6-NEXT:    s_sub_i32 s14, 64, s12
...
; GFX6-NEXT:    s_lshr_b64 s[6:7], s[6:7], s13
...
; GFX8-NEXT:    s_cselect_b64 s[8:9], s[10:11], s[14:15]
; GFX8-NEXT:    s_cmp_lg_u32 s16, 0
; GFX8-NEXT:    s_cselect_b64 s[8:9], s[0:1], s[8:9]
; GFX8-NEXT:    s_sub_i32 s13, s12, 64
; GFX8-NEXT:    s_sub_i32 s14, 64, s12
...
; GFX8-NEXT:    s_lshr_b64 s[6:7], s[6:7], s13
...
; GFX9-NEXT:    s_cselect_b64 s[8:9], s[10:11], s[14:15]
; GFX9-NEXT:    s_cmp_lg_u32 s16, 0
; GFX9-NEXT:    s_cselect_b64 s[8:9], s[0:1], s[8:9]
; GFX9-NEXT:    s_sub_i32 s13, s12, 64
; GFX9-NEXT:    s_sub_i32 s14, 64, s12
...
; GFX9-NEXT:    s_lshr_b64 s[6:7], s[6:7], s13
...
; GFX10-NEXT:    s_sub_i32 s9, s8, 64
; GFX10-NEXT:    s_sub_i32 s10, 64, s8
...
; GFX10-NEXT:    s_lshr_b64 s[14:15], s[6:7], s12
; GFX10-NEXT:    s_or_b64 s[0:1], s[0:1], s[10:11]
; GFX10-NEXT:    s_lshr_b64 s[6:7], s[6:7], s13
...
; GFX11-NEXT:    s_sub_i32 s9, s8, 64
; GFX11-NEXT:    s_sub_i32 s10, 64, s8
...
; GFX11-NEXT:    s_sub_i32 s13, s12, 64
...
; GFX11-NEXT:    s_lshr_b64 s[14:15], s[6:7], s12
; GFX11-NEXT:    s_or_b64 s[0:1], s[0:1], s[10:11]
; GFX11-NEXT:    s_lshr_b64 s[6:7], s[6:7], s13
...
; GFX11-NEXT:    s_cmp_lg_u32 s16, 0
; GFX11-NEXT:    s_cselect_b64 s[4:5], s[14:15], 0
...
; GFX6-NEXT:    s_lshl_b64 s[12:13], s[0:1], s4
; GFX6-NEXT:    s_lshl_b64 s[2:3], s[10:11], s4
; GFX6-NEXT:    s_or_b64 s[6:7], s[6:7], s[12:13]
; GFX6-NEXT:    s_lshl_b64 s[10:11], s[10:11], s5
; GFX6-NEXT:    s_cmp_eq_u32 s4, 0
; GFX6-NEXT:    s_cselect_b32 s12, 1, 0
; GFX6-NEXT:    s_cmp_lg_u32 s9, 0
; GFX6-NEXT:    s_cselect_b64 s[2:3], s[2:3], 0
; GFX6-NEXT:    s_cselect_b64 s[4:5], s[6:7], s[10:11]
; GFX6-NEXT:    s_cmp_lg_u32 s12, 0
...
; GFX8-NEXT:    s_lshr_b64 s[6:7], s[10:11], s6
; GFX8-NEXT:    s_lshl_b64 s[12:13], s[0:1], s4
; GFX8-NEXT:    s_lshl_b64 s[2:3], s[10:11], s4
; GFX8-NEXT:    s_or_b64 s[6:7], s[6:7], s[12:13]
; GFX8-NEXT:    s_lshl_b64 s[10:11], s[10:11], s5
; GFX8-NEXT:    s_cmp_eq_u32 s4, 0
; GFX8-NEXT:    s_cselect_b32 s12, 1, 0
; GFX8-NEXT:    s_cmp_lg_u32 s9, 0
; GFX8-NEXT:    s_cselect_b64 s[2:3], s[2:3], 0
; GFX8-NEXT:    s_cselect_b64 s[4:5], s[6:7], s[10:11]
; GFX8-NEXT:    s_cmp_lg_u32 s12, 0
...
; GFX9-NEXT:    s_lshr_b64 s[6:7], s[10:11], s6
; GFX9-NEXT:    s_lshl_b64 s[12:13], s[0:1], s4
; GFX9-NEXT:    s_lshl_b64 s[2:3], s[10:11], s4
; GFX9-NEXT:    s_or_b64 s[6:7], s[6:7], s[12:13]
; GFX9-NEXT:    s_lshl_b64 s[10:11], s[10:11], s5
; GFX9-NEXT:    s_cmp_eq_u32 s4, 0
; GFX9-NEXT:    s_cselect_b32 s12, 1, 0
; GFX9-NEXT:    s_cmp_lg_u32 s9, 0
; GFX9-NEXT:    s_cselect_b64 s[2:3], s[2:3], 0
; GFX9-NEXT:    s_cselect_b64 s[4:5], s[6:7], s[10:11]
; GFX9-NEXT:    s_cmp_lg_u32 s12, 0
...
; GFX10-NEXT:    s_lshl_b64 s[12:13], s[0:1], s4
...
; GFX11-NEXT:    s_lshl_b64 s[12:13], s[0:1], s4
...
; GFX6-NEXT:    s_cmp_lt_u32 s8, 64
; GFX6-NEXT:    v_cmp_ne_u32_e64 vcc, 0, s7
; GFX6-NEXT:    s_cselect_b32 s12, 1, 0
...
; GFX6-NEXT:    s_lshr_b64 s[2:3], s[2:3], s9
; GFX6-NEXT:    s_cmp_eq_u32 s8, 0
...
; GFX8-NEXT:    s_cmp_lt_u32 s8, 64
; GFX8-NEXT:    v_cmp_ne_u32_e64 vcc, 0, s7
; GFX8-NEXT:    s_cselect_b32 s12, 1, 0
...
; GFX8-NEXT:    s_lshr_b64 s[2:3], s[2:3], s9
; GFX8-NEXT:    s_cmp_eq_u32 s8, 0
...
; GFX9-NEXT:    s_cmp_lt_u32 s8, 64
; GFX9-NEXT:    v_cmp_ne_u32_e64 vcc, 0, s7
; GFX9-NEXT:    s_cselect_b32 s12, 1, 0
...
; GFX9-NEXT:    s_lshr_b64 s[2:3], s[2:3], s9
; GFX9-NEXT:    s_cmp_eq_u32 s8, 0
...
; GFX10-NEXT:    s_lshr_b64 s[10:11], s[2:3], s8
...
; GFX11-NEXT:    s_lshr_b64 s[10:11], s[2:3], s8
...
; GFX6-NEXT:    s_lshl_b64 s[20:21], s[4:5], s10
...
; GFX6-NEXT:    s_cselect_b64 s[10:11], s[18:19], s[16:17]
; GFX6-NEXT:    s_cmp_lg_u32 s9, 0
; GFX6-NEXT:    s_cselect_b64 s[10:11], s[4:5], s[10:11]
; GFX6-NEXT:    s_sub_i32 s9, s8, 64
; GFX6-NEXT:    s_sub_i32 s18, 64, s8
; GFX6-NEXT:    s_cmp_lt_u32 s8, 64
; GFX6-NEXT:    s_cselect_b32 s20, 1, 0
; GFX6-NEXT:    s_lshr_b64 s[16:17], s[12:13], s8
; GFX6-NEXT:    s_lshl_b64 s[18:19], s[14:15], s18
; GFX6-NEXT:    s_lshr_b64 s[4:5], s[14:15], s8
; GFX6-NEXT:    s_or_b64 s[16:17], s[16:17], s[18:19]
; GFX6-NEXT:    s_lshr_b64 s[14:15], s[14:15], s9
; GFX6-NEXT:    s_cmp_eq_u32 s8, 0
; GFX6-NEXT:    s_cselect_b32 s18, 1, 0
; GFX6-NEXT:    s_cmp_lg_u32 s20, 0
; GFX6-NEXT:    s_cselect_b64 s[8:9], s[16:17], s[14:15]
...
; GFX8-NEXT:    s_lshl_b64 s[20:21], s[4:5], s10
...
; GFX8-NEXT:    s_cselect_b64 s[10:11], s[18:19], s[16:17]
; GFX8-NEXT:    s_cmp_lg_u32 s9, 0
; GFX8-NEXT:    s_cselect_b64 s[10:11], s[4:5], s[10:11]
; GFX8-NEXT:    s_sub_i32 s9, s8, 64
; GFX8-NEXT:    s_sub_i32 s18, 64, s8
; GFX8-NEXT:    s_cmp_lt_u32 s8, 64
; GFX8-NEXT:    s_cselect_b32 s20, 1, 0
; GFX8-NEXT:    s_lshr_b64 s[16:17], s[12:13], s8
; GFX8-NEXT:    s_lshl_b64 s[18:19], s[14:15], s18
; GFX8-NEXT:    s_lshr_b64 s[4:5], s[14:15], s8
; GFX8-NEXT:    s_or_b64 s[16:17], s[16:17], s[18:19]
; GFX8-NEXT:    s_lshr_b64 s[14:15], s[14:15], s9
; GFX8-NEXT:    s_cmp_eq_u32 s8, 0
; GFX8-NEXT:    s_cselect_b32 s18, 1, 0
; GFX8-NEXT:    s_cmp_lg_u32 s20, 0
; GFX8-NEXT:    s_cselect_b64 s[8:9], s[16:17], s[14:15]
...
; GFX9-NEXT:    s_lshl_b64 s[20:21], s[4:5], s10
...
; GFX9-NEXT:    s_cselect_b64 s[10:11], s[18:19], s[16:17]
; GFX9-NEXT:    s_cmp_lg_u32 s9, 0
; GFX9-NEXT:    s_cselect_b64 s[10:11], s[4:5], s[10:11]
; GFX9-NEXT:    s_sub_i32 s9, s8, 64
; GFX9-NEXT:    s_sub_i32 s18, 64, s8
; GFX9-NEXT:    s_cmp_lt_u32 s8, 64
; GFX9-NEXT:    s_cselect_b32 s20, 1, 0
; GFX9-NEXT:    s_lshr_b64 s[16:17], s[12:13], s8
; GFX9-NEXT:    s_lshl_b64 s[18:19], s[14:15], s18
; GFX9-NEXT:    s_lshr_b64 s[4:5], s[14:15], s8
; GFX9-NEXT:    s_or_b64 s[16:17], s[16:17], s[18:19]
; GFX9-NEXT:    s_lshr_b64 s[14:15], s[14:15], s9
; GFX9-NEXT:    s_cmp_eq_u32 s8, 0
; GFX9-NEXT:    s_cselect_b32 s18, 1, 0
; GFX9-NEXT:    s_cmp_lg_u32 s20, 0
; GFX9-NEXT:    s_cselect_b64 s[8:9], s[16:17], s[14:15]
...
; GFX10-NEXT:    s_sub_i32 s17, s16, 64
; GFX10-NEXT:    s_sub_i32 s23, 64, s16
...
; GFX10-NEXT:    s_lshl_b64 s[28:29], s[0:1], s16
...
; GFX10-NEXT:    s_cselect_b64 s[16:17], s[28:29], 0
; GFX10-NEXT:    s_cselect_b64 s[0:1], s[24:25], s[0:1]
; GFX10-NEXT:    s_cmp_lg_u32 s23, 0
; GFX10-NEXT:    s_cselect_b64 s[2:3], s[2:3], s[0:1]
; GFX10-NEXT:    s_sub_i32 s23, s22, 64
; GFX10-NEXT:    s_sub_i32 s24, 64, s22
; GFX10-NEXT:    s_cmp_lt_u32 s22, 64
; GFX10-NEXT:    s_cselect_b32 s28, 1, 0
; GFX10-NEXT:    s_lshr_b64 s[0:1], s[8:9], s22
; GFX10-NEXT:    s_lshl_b64 s[24:25], s[10:11], s24
; GFX10-NEXT:    s_lshr_b64 s[26:27], s[10:11], s22
; GFX10-NEXT:    s_or_b64 s[0:1], s[0:1], s[24:25]
; GFX10-NEXT:    s_lshr_b64 s[10:11], s[10:11], s23
...
; GFX11-NEXT:    s_sub_i32 s17, s16, 64
; GFX11-NEXT:    s_sub_i32 s23, 64, s16
...
; GFX11-NEXT:    s_lshl_b64 s[28:29], s[0:1], s16
...
; GFX11-NEXT:    s_cselect_b64 s[16:17], s[28:29], 0
; GFX11-NEXT:    s_cselect_b64 s[0:1], s[24:25], s[0:1]
; GFX11-NEXT:    s_cmp_lg_u32 s23, 0
; GFX11-NEXT:    s_cselect_b64 s[2:3], s[2:3], s[0:1]
; GFX11-NEXT:    s_sub_i32 s23, s22, 64
; GFX11-NEXT:    s_sub_i32 s24, 64, s22
; GFX11-NEXT:    s_cmp_lt_u32 s22, 64
; GFX11-NEXT:    s_cselect_b32 s28, 1, 0
; GFX11-NEXT:    s_lshr_b64 s[0:1], s[8:9], s22
; GFX11-NEXT:    s_lshl_b64 s[24:25], s[10:11], s24
; GFX11-NEXT:    s_lshr_b64 s[26:27], s[10:11], s22
; GFX11-NEXT:    s_or_b64 s[0:1], s[0:1], s[24:25]
; GFX11-NEXT:    s_lshr_b64 s[10:11], s[10:11], s23
...
; GFX11-NEXT:    s_cmp_lg_u32 s28, 0
; GFX11-NEXT:    s_cselect_b64 s[8:9], s[26:27], 0
