...
; GCN-NEXT:    s_lshl_b64 s[10:11], s[4:5], s2
...
; GCN-NEXT:    s_ashr_i64 s[4:5], s[4:5], s12
...
; GCN-NEXT:    s_cmp_lg_u32 s13, 0
; GCN-NEXT:    s_cselect_b64 s[2:3], s[6:7], s[2:3]
; GCN-NEXT:    ; return to shader part epilog
;
...
; GFX10PLUS-NEXT:    s_ashr_i64 s[10:11], s[4:5], s3
...
; GFX10PLUS-NEXT:    s_cmp_lg_u32 s13, 0
; GFX10PLUS-NEXT:    s_cselect_b64 s[2:3], s[10:11], s[2:3]
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = ashr i65 %value, %amount
  ret i65 %result
}
