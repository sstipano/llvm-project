...
; GFX6-NEXT:    s_lshl_b64 s[18:19], s[2:3], s12
...
; GFX6-NEXT:    s_cselect_b64 s[12:13], s[14:15], 0
...
; GFX8-NEXT:    s_lshl_b64 s[18:19], s[2:3], s12
...
; GFX8-NEXT:    s_cselect_b64 s[12:13], s[14:15], 0
...
; GFX9-NEXT:    s_lshl_b64 s[18:19], s[2:3], s12
...
; GFX9-NEXT:    s_cselect_b64 s[12:13], s[14:15], 0
...
; GFX10-NEXT:    s_lshl_b64 s[18:19], s[0:1], s12
...
; GFX10-NEXT:    s_lshr_b64 s[14:15], s[4:5], s8
...
; GFX11-NEXT:    s_lshl_b64 s[18:19], s[0:1], s12
...
; GFX11-NEXT:    s_cselect_b64 s[12:13], s[18:19], 0
...
; GFX11-NEXT:    s_lshr_b64 s[14:15], s[4:5], s8
...
; GFX6-NEXT:    s_lshl_b64 s[12:13], s[2:3], s8
...
; GFX8-NEXT:    s_lshl_b64 s[12:13], s[2:3], s8
...
; GFX9-NEXT:    s_lshl_b64 s[12:13], s[2:3], s8
...
; GFX6-NEXT:    v_or_b32_e32 v4, v4, v6
; GFX6-NEXT:    v_or_b32_e32 v5, v5, v7
; GFX6-NEXT:    v_cmp_ne_u32_e64 vcc, 0, s9
...
; GFX6-NEXT:    s_lshr_b64 s[8:9], s[0:1], s4
...
; GFX8-NEXT:    v_or_b32_e32 v4, v4, v6
; GFX8-NEXT:    v_or_b32_e32 v5, v5, v7
; GFX8-NEXT:    v_cmp_ne_u32_e64 vcc, 0, s9
...
; GFX8-NEXT:    s_lshr_b64 s[8:9], s[0:1], s4
...
; GFX9-NEXT:    v_or_b32_e32 v4, v4, v6
; GFX9-NEXT:    v_or_b32_e32 v5, v5, v7
; GFX9-NEXT:    v_cmp_ne_u32_e64 vcc, 0, s9
...
; GFX9-NEXT:    s_lshr_b64 s[8:9], s[0:1], s4
...
; GFX10-NEXT:    s_lshr_b64 s[2:3], s[2:3], 1
; GFX10-NEXT:    s_sub_i32 s12, s4, 64
...
; GFX10-NEXT:    s_lshr_b64 s[10:11], s[2:3], s4
...
; GFX11-NEXT:    s_lshr_b64 s[2:3], s[2:3], 1
; GFX11-NEXT:    s_sub_i32 s12, s4, 64
...
; GFX11-NEXT:    s_lshr_b64 s[10:11], s[2:3], s4
...
; GFX6-NEXT:    s_lshl_b64 s[28:29], s[2:3], s22
...
; GFX6-NEXT:    s_cselect_b64 s[22:23], s[24:25], 0
...
; GFX6-NEXT:    s_sub_i32 s26, 64, s16
; GFX6-NEXT:    s_cmp_lt_u32 s16, 64
; GFX6-NEXT:    s_cselect_b32 s28, 1, 0
; GFX6-NEXT:    s_lshr_b64 s[24:25], s[0:1], s16
; GFX6-NEXT:    s_lshl_b64 s[26:27], s[8:9], s26
...
; GFX6-NEXT:    s_cselect_b64 s[8:9], s[24:25], s[8:9]
; GFX6-NEXT:    s_cmp_lg_u32 s16, 0
...
; GFX6-NEXT:    s_sub_i32 s9, s8, 64
; GFX6-NEXT:    s_sub_i32 s11, 64, s8
; GFX6-NEXT:    s_cmp_lt_u32 s8, 64
; GFX6-NEXT:    s_cselect_b32 s18, 1, 0
; GFX6-NEXT:    s_lshr_b64 s[20:21], s[4:5], s11
; GFX6-NEXT:    s_lshl_b64 s[22:23], s[6:7], s8
; GFX6-NEXT:    s_lshl_b64 s[16:17], s[4:5], s8
; GFX6-NEXT:    s_or_b64 s[20:21], s[20:21], s[22:23]
; GFX6-NEXT:    s_lshl_b64 s[4:5], s[4:5], s9
; GFX6-NEXT:    s_cmp_eq_u32 s8, 0
; GFX6-NEXT:    s_cselect_b32 s11, 1, 0
; GFX6-NEXT:    s_cmp_lg_u32 s18, 0
; GFX6-NEXT:    s_cselect_b64 s[8:9], s[16:17], 0
; GFX6-NEXT:    s_cselect_b64 s[4:5], s[20:21], s[4:5]
...
; GFX6-NEXT:    s_lshr_b64 s[12:13], s[14:15], 1
; GFX6-NEXT:    s_sub_i32 s11, s10, 64
; GFX6-NEXT:    s_sub_i32 s18, 64, s10
; GFX6-NEXT:    s_cmp_lt_u32 s10, 64
; GFX6-NEXT:    s_cselect_b32 s20, 1, 0
; GFX6-NEXT:    s_lshr_b64 s[16:17], s[4:5], s10
; GFX6-NEXT:    s_lshl_b64 s[18:19], s[12:13], s18
; GFX6-NEXT:    s_lshr_b64 s[14:15], s[12:13], s10
; GFX6-NEXT:    s_or_b64 s[16:17], s[16:17], s[18:19]
; GFX6-NEXT:    s_lshr_b64 s[12:13], s[12:13], s11
; GFX6-NEXT:    s_cmp_eq_u32 s10, 0
; GFX6-NEXT:    s_cselect_b32 s18, 1, 0
; GFX6-NEXT:    s_cmp_lg_u32 s20, 0
; GFX6-NEXT:    s_cselect_b64 s[10:11], s[16:17], s[12:13]
; GFX6-NEXT:    s_cmp_lg_u32 s18, 0
; GFX6-NEXT:    s_cselect_b64 s[4:5], s[4:5], s[10:11]
; GFX6-NEXT:    s_cmp_lg_u32 s20, 0
; GFX6-NEXT:    s_cselect_b64 s[10:11], s[14:15], 0
...
; GFX8-NEXT:    s_lshl_b64 s[28:29], s[2:3], s22
...
; GFX8-NEXT:    s_cselect_b64 s[22:23], s[24:25], 0
...
; GFX8-NEXT:    s_sub_i32 s9, s8, 64
; GFX8-NEXT:    s_sub_i32 s11, 64, s8
; GFX8-NEXT:    s_cmp_lt_u32 s8, 64
; GFX8-NEXT:    s_cselect_b32 s18, 1, 0
; GFX8-NEXT:    s_lshr_b64 s[20:21], s[4:5], s11
; GFX8-NEXT:    s_lshl_b64 s[22:23], s[6:7], s8
; GFX8-NEXT:    s_lshl_b64 s[16:17], s[4:5], s8
; GFX8-NEXT:    s_or_b64 s[20:21], s[20:21], s[22:23]
; GFX8-NEXT:    s_lshl_b64 s[4:5], s[4:5], s9
; GFX8-NEXT:    s_cmp_eq_u32 s8, 0
; GFX8-NEXT:    s_cselect_b32 s11, 1, 0
; GFX8-NEXT:    s_cmp_lg_u32 s18, 0
; GFX8-NEXT:    s_cselect_b64 s[8:9], s[16:17], 0
; GFX8-NEXT:    s_cselect_b64 s[4:5], s[20:21], s[4:5]
...
; GFX8-NEXT:    s_lshr_b64 s[12:13], s[14:15], 1
; GFX8-NEXT:    s_sub_i32 s11, s10, 64
; GFX8-NEXT:    s_sub_i32 s18, 64, s10
; GFX8-NEXT:    s_cmp_lt_u32 s10, 64
; GFX8-NEXT:    s_cselect_b32 s20, 1, 0
; GFX8-NEXT:    s_lshr_b64 s[16:17], s[4:5], s10
; GFX8-NEXT:    s_lshl_b64 s[18:19], s[12:13], s18
; GFX8-NEXT:    s_lshr_b64 s[14:15], s[12:13], s10
; GFX8-NEXT:    s_or_b64 s[16:17], s[16:17], s[18:19]
; GFX8-NEXT:    s_lshr_b64 s[12:13], s[12:13], s11
...
; GFX8-NEXT:    s_cmp_lg_u32 s20, 0
; GFX8-NEXT:    s_cselect_b64 s[10:11], s[14:15], 0
...
; GFX9-NEXT:    s_lshl_b64 s[28:29], s[2:3], s22
...
; GFX9-NEXT:    s_cselect_b64 s[22:23], s[24:25], 0
...
; GFX9-NEXT:    s_sub_i32 s9, s8, 64
; GFX9-NEXT:    s_sub_i32 s11, 64, s8
; GFX9-NEXT:    s_cmp_lt_u32 s8, 64
; GFX9-NEXT:    s_cselect_b32 s18, 1, 0
; GFX9-NEXT:    s_lshr_b64 s[20:21], s[4:5], s11
; GFX9-NEXT:    s_lshl_b64 s[22:23], s[6:7], s8
; GFX9-NEXT:    s_lshl_b64 s[16:17], s[4:5], s8
; GFX9-NEXT:    s_or_b64 s[20:21], s[20:21], s[22:23]
; GFX9-NEXT:    s_lshl_b64 s[4:5], s[4:5], s9
; GFX9-NEXT:    s_cmp_eq_u32 s8, 0
; GFX9-NEXT:    s_cselect_b32 s11, 1, 0
; GFX9-NEXT:    s_cmp_lg_u32 s18, 0
; GFX9-NEXT:    s_cselect_b64 s[8:9], s[16:17], 0
; GFX9-NEXT:    s_cselect_b64 s[4:5], s[20:21], s[4:5]
...
; GFX9-NEXT:    s_lshr_b64 s[12:13], s[14:15], 1
; GFX9-NEXT:    s_sub_i32 s11, s10, 64
; GFX9-NEXT:    s_sub_i32 s18, 64, s10
; GFX9-NEXT:    s_cmp_lt_u32 s10, 64
; GFX9-NEXT:    s_cselect_b32 s20, 1, 0
; GFX9-NEXT:    s_lshr_b64 s[16:17], s[4:5], s10
; GFX9-NEXT:    s_lshl_b64 s[18:19], s[12:13], s18
; GFX9-NEXT:    s_lshr_b64 s[14:15], s[12:13], s10
; GFX9-NEXT:    s_or_b64 s[16:17], s[16:17], s[18:19]
; GFX9-NEXT:    s_lshr_b64 s[12:13], s[12:13], s11
; GFX9-NEXT:    s_cmp_eq_u32 s10, 0
; GFX9-NEXT:    s_cselect_b32 s18, 1, 0
; GFX9-NEXT:    s_cmp_lg_u32 s20, 0
; GFX9-NEXT:    s_cselect_b64 s[10:11], s[16:17], s[12:13]
; GFX9-NEXT:    s_cmp_lg_u32 s18, 0
; GFX9-NEXT:    s_cselect_b64 s[4:5], s[4:5], s[10:11]
; GFX9-NEXT:    s_cmp_lg_u32 s20, 0
; GFX9-NEXT:    s_cselect_b64 s[10:11], s[14:15], 0
...
; GFX10-NEXT:    s_lshl_b64 s[28:29], s[0:1], s22
...
; GFX10-NEXT:    s_cselect_b64 s[22:23], s[28:29], 0
...
; GFX10-NEXT:    s_sub_i32 s24, 64, s16
; GFX10-NEXT:    s_cmp_lt_u32 s16, 64
; GFX10-NEXT:    s_cselect_b32 s28, 1, 0
; GFX10-NEXT:    s_lshr_b64 s[10:11], s[0:1], s16
; GFX10-NEXT:    s_lshl_b64 s[24:25], s[8:9], s24
; GFX10-NEXT:    s_lshr_b64 s[26:27], s[8:9], s16
; GFX10-NEXT:    s_or_b64 s[10:11], s[10:11], s[24:25]
; GFX10-NEXT:    s_lshr_b64 s[8:9], s[8:9], s17
...
; GFX10-NEXT:    s_lshl_b64 s[16:17], s[12:13], s16
; GFX10-NEXT:    s_lshr_b64 s[18:19], s[12:13], s10
; GFX10-NEXT:    s_or_b64 s[14:15], s[14:15], s[16:17]
; GFX10-NEXT:    s_lshr_b64 s[12:13], s[12:13], s11
; GFX10-NEXT:    s_cmp_eq_u32 s10, 0
; GFX10-NEXT:    s_cselect_b32 s16, 1, 0
; GFX10-NEXT:    s_cmp_lg_u32 s20, 0
; GFX10-NEXT:    s_cselect_b64 s[10:11], s[14:15], s[12:13]
; GFX10-NEXT:    s_cmp_lg_u32 s16, 0
; GFX10-NEXT:    s_cselect_b64 s[4:5], s[4:5], s[10:11]
; GFX10-NEXT:    s_cmp_lg_u32 s20, 0
; GFX10-NEXT:    s_cselect_b64 s[10:11], s[18:19], 0
...
; GFX11-NEXT:    s_lshl_b64 s[28:29], s[0:1], s22
...
; GFX11-NEXT:    s_cselect_b64 s[22:23], s[28:29], 0
...
; GFX11-NEXT:    s_sub_i32 s24, 64, s16
; GFX11-NEXT:    s_cmp_lt_u32 s16, 64
; GFX11-NEXT:    s_cselect_b32 s28, 1, 0
; GFX11-NEXT:    s_lshr_b64 s[10:11], s[0:1], s16
; GFX11-NEXT:    s_lshl_b64 s[24:25], s[8:9], s24
; GFX11-NEXT:    s_lshr_b64 s[26:27], s[8:9], s16
; GFX11-NEXT:    s_or_b64 s[10:11], s[10:11], s[24:25]
; GFX11-NEXT:    s_lshr_b64 s[8:9], s[8:9], s17
...
; GFX11-NEXT:    s_sub_i32 s11, s10, 64
...
; GFX11-NEXT:    s_lshl_b64 s[16:17], s[12:13], s16
; GFX11-NEXT:    s_lshr_b64 s[18:19], s[12:13], s10
; GFX11-NEXT:    s_or_b64 s[14:15], s[14:15], s[16:17]
; GFX11-NEXT:    s_lshr_b64 s[12:13], s[12:13], s11
; GFX11-NEXT:    s_cmp_eq_u32 s10, 0
; GFX11-NEXT:    s_cselect_b32 s16, 1, 0
; GFX11-NEXT:    s_cmp_lg_u32 s20, 0
; GFX11-NEXT:    s_cselect_b64 s[10:11], s[14:15], s[12:13]
; GFX11-NEXT:    s_cmp_lg_u32 s16, 0
; GFX11-NEXT:    s_cselect_b64 s[4:5], s[4:5], s[10:11]
; GFX11-NEXT:    s_cmp_lg_u32 s20, 0
; GFX11-NEXT:    s_cselect_b64 s[10:11], s[18:19], 0
