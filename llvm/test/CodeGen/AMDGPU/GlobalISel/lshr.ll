...
; GFX10PLUS-NEXT:    s_sub_i32 s2, s3, 64
...
; GFX10PLUS-NEXT:    s_lshr_b64 s[4:5], s[4:5], s2
...
; GFX10PLUS-NEXT:    s_cmp_lg_u32 s12, 0
; GFX10PLUS-NEXT:    s_cselect_b64 s[2:3], s[10:11], 0
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr i65 %value, %amount
  ret i65 %result
}
